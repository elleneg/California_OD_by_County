...
# 3. Process Data into the 'final' variable
...
sheet.clear()
# This creates the list from the 'final' dataframe created in Step 3
data_to_upload = [final.columns.values.tolist()] + final.values.tolist()
sheet.update('A1', data_to_upload)

print("✅ SUCCESS: Google Sheet 'CA_Death_Data' updated!")
